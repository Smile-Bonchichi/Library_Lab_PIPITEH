...
public class MainActivity extends Activity implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        final CharSequence[] items = {getText(R.string.red)  , getText(R.string.yellow),getText(R.string.green),getText(R.string.violet),getText(R.string.black)
        };
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                switch (item) {
                    ...
                    case 2:   {relativeLayout.setBackgroundResource(R.color.greenColor);
                        ...
                        break;}
                    case 3:   {relativeLayout.setBackgroundResource(R.color.violetColor);
                        Toast.makeText(context, R.string.violet, Toast.LENGTH_LONG).show();

                        break;}
                    case 4:   {relativeLayout.setBackgroundResource(R.color.blackColor);
